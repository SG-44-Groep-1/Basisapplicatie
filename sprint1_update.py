...
with open('steam_sorted.json') as jsondata:
...
def alle():
    root.title('Overview - Top 5 games')
    root.geometry('+100+200')
    destroy_frames()
    place_alle(frame1)

def gratis():
    root.title('Overview - Top 5 free games')
    root.geometry('+100+200')
    destroy_frames()
    place_gratis(frame1)

def onder1():
    root.title('Overview - Top 5 games under €1')
    root.geometry('+100+200')
    destroy_frames()
    place_onder1(frame1)

def onder5():
    root.title('Overview - Top 5 games under €5')
    root.geometry('+100+200')
    destroy_frames()
    place_onder5(frame1)

def onder10():
    root.title('Overview - Top 5 games under €10')
    root.geometry('+100+200')
    destroy_frames()
    place_onder10(frame1)
...
editmenu.add_command(label="Top 5 games", command=alle)
editmenu.add_command(label="Top 5 free games", command=gratis)
editmenu.add_command(label="Top 5 games under €1", command=onder1)
editmenu.add_command(label="Top 5 games under €5", command=onder5)
editmenu.add_command(label="Top 5 games under €10", command=onder10)
